...
import { HiBars3CenterLeft, HiOutlineHeart, HiOutlineShoppingCart, HiOutlineUser } from "react-icons/hi2";
              ...
              <div>
                {
                  currentUser ? <><button onClick={()=> setIsDropdownOpen(!isDropdownOpen)}>
                    <img src="/avatar.png" alt="" className={`size-7 rounded-full ${currentUser ? 'ring-2 ring-blue-500': ''}` } />
                    </button>
                    {/* show dropd */}
                    {
                      isDropdownOpen &&(
